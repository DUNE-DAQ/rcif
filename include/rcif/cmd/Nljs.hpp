...
inline void
to_json(data_t& j, const ChangeRateParams& obj)
{
  j["trigger_rate"] = obj.trigger_rate;
}

inline void
from_json(const data_t& j, ChangeRateParams& obj)
{
...
inline void
to_json(data_t& j, const DisableParams& obj)
{
  j["resource_name"] = obj.resource_name;
}

inline void
from_json(const data_t& j, DisableParams& obj)
{
...
inline void
to_json(data_t& j, const EnableParams& obj)
{
  j["resource_name"] = obj.resource_name;
}

inline void
from_json(const data_t& j, EnableParams& obj)
{
  if (j.contains("resource_name"))
    j.at("resource_name").get_to(obj.resource_name);
}
...
inline void
to_json(data_t& j, const RCCommand& obj)
{
  j["id"] = obj.id;
...
inline void
from_json(const data_t& j, RCCommand& obj)
{
  if (j.contains("id"))
...
inline void
to_json(data_t& j, const StartParams& obj)
{
  j["run"] = obj.run;
...
inline void
from_json(const data_t& j, StartParams& obj)
{
  if (j.contains("run"))
